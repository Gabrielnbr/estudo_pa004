...
class HealthInsurance:
    def __init__(self):
        ...
        self.premio_anual_mms =            self.home_path+"features/mms_pa.pkl"
        self.idade =                       self.home_path+"features/mms_idade.pkl"
        self.clientes_dia_contrato_mms =   self.home_path+"features/mms_cdc.pkl"
        self.semanas_contrato_mms =        self.home_path+"features/mms_sc.pkl"
        self.meses_contrato_mms =          self.home_path+"features/mms_mc.pkl"
        self.genero_te =                   self.home_path+"features/target_encode_genero.pkl"
        self.codigo_regisao_te =           self.home_path+"features/target_encode_codigo_regiao.pkl"
        self.contato_cliente_fe =          self.home_path+"features/fe_contato_cliente.pkl"
